...
return (
  <div className="stock-features">
    ...
    <div style={{marginTop:50}} className="icons">
      <div className="icon">
        ...
        />
        <div className="icon-title">Store previous searches</div>
        <div>
      </div>
    </div>
    <div className="icon">
        ...
        <img 
          ...
          onMouseLeave={() => setVisibilityBottom(true) & setCurrentVisibility('visibilityBottom')}
        />
        <div className="icon-title">See every transaction</div>
        <div>
      </div>
    </div>
    <div className="icon">
        ...
        <img 
          ...
          onMouseLeave={() => setVisibilityBottom(true) & setCurrentVisibility('visibilityBottom')}
        />
        <div className="icon-title">Add more cash</div>
        <div>
      </div>
    </div>
    <div style={{display:'flex', justifyContent: 'center', flexWrap: 'wrap', maxWidth: 220}} className="icon">
        <img 
          ...
          onMouseLeave={() => setVisibilityBottom(true) & setCurrentVisibility('visibilityBottom')}
        />
        <div className="icon-title" >Easily Buy/Sell Stocks</div>
        <div>
      </div>
    </div>
    </div>
